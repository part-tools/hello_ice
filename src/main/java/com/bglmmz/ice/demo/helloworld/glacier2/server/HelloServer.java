package com.bglmmz.ice.demo.helloworld.glacier2.server;
...
public class HelloServer {
    public static void main(String[] args) {
        ...
        try (com.zeroc.Ice.Communicator ic = com.zeroc.Ice.Util.initialize(args)){
            ...
            com.zeroc.Ice.ObjectAdapter adapter = ic.createObjectAdapterWithEndpoints("HelloServiceAdapter", "tcp -h 192.168.21.26 -p 10001");
